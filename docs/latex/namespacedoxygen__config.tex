\doxysection{Imenski prostor doxygen\+\_\+config}
\hypertarget{namespacedoxygen__config}{}\label{namespacedoxygen__config}\index{doxygen\_config@{doxygen\_config}}
\doxysubsubsection*{Strukture}
\begin{DoxyCompactItemize}
\item 
class \mbox{\hyperlink{classdoxygen__config_1_1DoxygenConfig}{Doxygen\+Config}}
\item 
class \mbox{\hyperlink{classdoxygen__config_1_1ParseException}{Parse\+Exception}}
\end{DoxyCompactItemize}


\doxysubsection{Podroben opis}
\begin{DoxyVerb}doxygen_config.py
