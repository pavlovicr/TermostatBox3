\doxysection{Imenski prostor filter\+\_\+docker\+\_\+benchmark\+\_\+logs}
\hypertarget{namespacefilter__docker__benchmark__logs}{}\label{namespacefilter__docker__benchmark__logs}\index{filter\_docker\_benchmark\_logs@{filter\_docker\_benchmark\_logs}}
\doxysubsubsection*{Funkcije}
\begin{DoxyCompactItemize}
\item 
\Hypertarget{namespacefilter__docker__benchmark__logs_a71dfa38be04053db4e19a1c672b41abd}\label{namespacefilter__docker__benchmark__logs_a71dfa38be04053db4e19a1c672b41abd} 
{\bfseries main} ()
\end{DoxyCompactItemize}


\doxysubsection{Podroben opis}
\begin{DoxyVerb}This script parses a docker logs file for the lv_benchmark summary results
